			...
			<div id="primary" class="content-area column full">
				...
				<div id="container">
					<div id="content" role="main">
						<nav class="woocommerce-breadcrumb" itemprop="breadcrumb"><a href="#">Home</a> / <a href="#">Trainer</a> / Kim Jin-hae</nav>
						<div itemscope itemtype="http://schema.org/Product" class="product">
							<div class="images">
								<a href="" itemprop="image" class="woocommerce-main-image zoom" title="" data-rel="prettyPhoto">								
								<img src="img/health/1.m.jpg" alt=""></img></a>
							</div>
							<div class="summary entry-summary">
								<h1 itemprop="name" class="product_title entry-title">Kim Jin-hae</h1>
								...
								<div itemprop="offers" itemscope itemtype="http://schema.org/Offer">
									<p class="price">
										<span class="amount">Monthly trainer cost - $125.00</span>
									</p>
...
만들어가고 싶습니다.<p>
								...
								<a href = "http://localhost:8080/shop1/bookInfo.jsp?isbn=9788992939508">
...
자격사항<p>
- 국립 한국체육대학교 보디빌딩 특기생 실적우수자<br>
- 미스터서울 +90kg 헤비급 2~4위 다수 수상<br>
- 춘계보디빌딩대회 헤비급 1위<br>
- YMCA 전국대회 헤비급 우승<br>
- 전국고교선수권대회 헤비급 우승<br>
									</p>
								...
								<div class="panel entry-content wc-tab" id="tab-reviews">
									<div id="reviews">
										<div id="comments">
											<h2>2 Reviews for Kim Jin-hae</h2>
