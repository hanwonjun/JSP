			...
			<div id="primary" class="content-area column full">
				...
				<div id="container">
					<div id="content" role="main">
						<nav class="woocommerce-breadcrumb" itemprop="breadcrumb"><a href="#">Home</a> / <a href="#">Trainer</a> / Shin ji</nav>
						<div itemscope itemtype="http://schema.org/Product" class="product">
							<div class="images">
								<a href="" itemprop="image" class="woocommerce-main-image zoom" title="" data-rel="prettyPhoto">								
								<img src="img/health/4.w.png" alt=""></img></a>
							</div>
							<div class="summary entry-summary">
								<h1 itemprop="name" class="product_title entry-title">Shin ji</h1>
								...
								<div itemprop="offers" itemscope itemtype="http://schema.org/Offer">
									<p class="price">
										<span class="amount">Monthly trainer cost - $36.00</span>
									</p>
...
만들어가고 싶습니다.<p>
								...
								<a href = "http://localhost:8080/shop1/bookInfo.jsp?isbn=9788996094012">
							...
							<div class="woocommerce-tabs wc-tabs-wrapper">
									...
									<p>
										경력사항<p>
-2013 MR&MS 서울 바디휘트니스 입상<br>
-2014 MR&MS 서울 바디휘트니스 2위<br>
-2014 MR&MS 서울 바디빌딩 3위<br>
-2014 KOREA GRAND PRIX BIKINI Top5<br>
-2017 올스타클레식 BIKINI Top 2위<br>
-2017 SAN MARINO 올림피아드 BIKINI Top4<br>
-2017 오버롤전 Top 3위<br>
-(현) 몬스터짐 및 맥시멈핏 후원선수
									</p>
								</div>
