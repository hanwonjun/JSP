			...
			<div id="primary" class="content-area column full">
				...
				<div id="container">
					<div id="content" role="main">
						<nav class="woocommerce-breadcrumb" itemprop="breadcrumb"><a href="#">Home</a> / <a href="#">Trainer</a> / Kim Min-jun</nav>
						<div itemscope itemtype="http://schema.org/Product" class="product">
							<div class="images">
								<a href="" itemprop="image" class="woocommerce-main-image zoom" title="" data-rel="prettyPhoto">								
								<img src="img/health/2.m.jpg" alt=""></img></a>
							</div>
							<div class="summary entry-summary">
								<h1 itemprop="name" class="product_title entry-title">Kim Min-jun</h1>
								...
								<div itemprop="offers" itemscope itemtype="http://schema.org/Offer">
									<p class="price">
										<span class="amount">Monthly trainer cost - $16.00</span>
									</p>
...
만들어가고 싶습니다.<p>
								...
								<a href = "http://localhost:8080/shop1/bookInfo.jsp?isbn=9788995379493">
							...
							<div class="woocommerce-tabs wc-tabs-wrapper">
									...
									<p>
										경력사항(퍼스널 트레이닝 7년)<p>
-2017 나바코리아 피지크 3위<br>
-2017 서울시협회장기 피지크 3위<br>
-2016 나바코리아 스포츠모델 3위<br>
-2015 나바코리아 스포츠모델 3위<br>
-마크짐 휘트니스 퍼스널 트레이너[팀장]<br>
-휘트니스 FM 퍼스널 트레이너 [팀장]<br>
-스포파크 휘트니스 퍼스널 트레이너<br>
...
자격사항
-FISAF KOREA 퍼스널 트레이너 자격증<br>
-운동처방사 3급 [대한 퍼스널트레이너 연맹]<br>
-심폐소생술[C.P.R] [대한적십자사]
									</p>
								</div>
								<div class="panel entry-content wc-tab" id="tab-reviews">
									<div id="reviews">
										<div id="comments">
											<h2>2 Reviews for Kim Min-jun</h2>
