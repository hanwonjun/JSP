		...
		<div id="content" class="site-content">
			<div id="primary" class="content-area column full">
				...
				<div class="entry-content">
					<p>
						Here are some of the elements you can use with Edge Gym theme:
					</p>
					<p>
					...
					<h4><i class="fa fa-heart" style="color:red;"></i> We hope you love Edge Gym theme as much as we do!</h4>
				</div>
				<!-- .entry-content -->
				</article>
				<div class="clearfix">
