...
public class BoardMgr {
	...
	private static final String  SAVEFOLDER = "D:/fileupload";
	...
	public BoardMgr() {
		try {
			pool = DBConnectionMgr.getInstance();//pool 얻어옴
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	// 게시판 리스트
	public Vector<BoardBean> getBoardList(String keyField, String keyWord, int start, int numPerPage) {
		Connection con = null;
	...
	//총 게시물수
	public int getTotalCount(String keyField, String keyWord) {//갯수세기
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
		...
		public void post1000(){
			...
			try {
				...
				for (int i = 0; i < 1000; i++) {
					...
					sql+="values('aaa', 'bbb', 'ccc', " + ref + " , 0, 0, now(), '1111',0, '127.0.0.1', null, 0);";
					pstmt = con.prepareStatement(sql);			
					pstmt.executeUpdate();
				}
			} catch (Exception e) {
